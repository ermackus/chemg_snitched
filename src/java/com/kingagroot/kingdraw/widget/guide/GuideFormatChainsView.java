...
public class GuideFormatChainsView extends FrameLayout implements GuideBaseView
{
    private final View contentView;
    private GuideBaseView guideBaseView;
    private final ImageButton imgbtnClose;
    
    public GuideFormatChainsView(final Context context) {
        this(context, null);
    }
    
    public GuideFormatChainsView(final Context context, final AttributeSet set) {
        super(context, set);
        final View inflate = View.inflate(context, 2131493068, (ViewGroup)this);
        this.contentView = inflate;
        (this.imgbtnClose = (ImageButton)inflate.findViewById(2131296887)).setOnClickListener((View$OnClickListener)new GuideFormatChainsView$1(this));
    }
