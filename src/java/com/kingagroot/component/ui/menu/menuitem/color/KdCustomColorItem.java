...
public class KdCustomColorItem extends FrameLayout implements MenuBaseItem, View$OnClickListener
{
    private int color;
    private MoreMenuPop moreMenuPop;
    private OnColorMenuItemListener onColorMenuItemListener;
    private final RotateTextView textView;
    
    public KdCustomColorItem(final Context context) {
        super(context);
        this.textView = (RotateTextView)View.inflate(context, R$layout.component_layout_menu_custom_color, (ViewGroup)this).findViewById(R$id.custom);
    ...
    public void setColor(final int n) {
        this.color = n;
        this.textView.setRotateColor(n);
    }
