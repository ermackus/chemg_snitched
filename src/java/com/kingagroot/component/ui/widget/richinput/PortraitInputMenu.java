...
public class PortraitInputMenu extends InputBaseMenu
{
    ...
    public PortraitInputMenu(final Context context) {
        ...
        this.onSymbolCheckedChangeListener = (CompoundButton$OnCheckedChangeListener)new PortraitInputMenu$2(this);
        this.onGlobalLayoutListener = (ViewTreeObserver$OnGlobalLayoutListener)new PortraitInputMenu$3(this);
    }
    
    public PortraitInputMenu(final Context context, final AttributeSet set) {
        super(context, set);
        this.maxScreen = 0;
        this.gravityType = GAlignEnum.left;
        this.onSymbolMenuClickListener = new OnMenuClickListener() {
        ...
        this.onSymbolCheckedChangeListener = (CompoundButton$OnCheckedChangeListener)new PortraitInputMenu$2(this);
        this.onGlobalLayoutListener = (ViewTreeObserver$OnGlobalLayoutListener)new PortraitInputMenu$3(this);
        this.contentView = View.inflate(context, R$layout.component_rich_input_menu_container_portrait, (ViewGroup)this);
        this.initView();
        this.initData();
        this.etRich.setImeOptions(268435456);
        this.cbA.setOnClickListener((View$OnClickListener)new PortraitInputMenu$4(this));
        this.etRich.addTextChangedListener((TextWatcher)new PortraitInputMenu$5(this));
    }
    ...
    private void initData() {
        ...
        this.flTop.setOnClickListener((View$OnClickListener)new PortraitInputMenu$6(this));
        this.tvConfirm.setOnClickListener((View$OnClickListener)new PortraitInputMenu$7(this));
        this.tvRichCancel.setOnClickListener((View$OnClickListener)new PortraitInputMenu$8(this));
        this.setAlignClick();
    ...
    private void initView() {
        ...
        this.tvRichCancel = (TextView)this.findViewById(R$id.tv_rich_cancel);
        ...
        this.flTop = (FrameLayout)this.findViewById(R$id.fl_top);
        this.llTopMenu = (LinearLayout)this.findViewById(R$id.ll_top_menu);
    ...
    private void setAlignClick() {
        this.rgpAlign.setOnCheckedChangeListener((RadioGroup$OnCheckedChangeListener)new PortraitInputMenu$9(this));
    }
    ...
    private void setExtendMenuHeight(final int height) {
        if (height > PortraitInputMenu.MENU_HEIGHT_MIN) {
    ...
    private void setRichEnable(final boolean rbtEnable, final FormatValue formatValue) {
        if (formatValue != null) {
            ...
            this.gStyleManager.setFontStyle(family, size, n, rbtEnable);
        }
    }
    ...
    public void setFontIsShow(final boolean b) {
        if (b) {
            ...
            this.etRich.addTextChangedListener((TextWatcher)new PortraitInputMenu$10(this));
