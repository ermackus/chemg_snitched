...
public class SettingItemView extends ToolBaseItemView
{
    public SettingItemView(final Context context) {
        super(context);
        this.init();
    }
    
    private void init() {
        this.setButtonDrawable(R$drawable.ic_draw_fileset_nor);
