...
public class ShareImageOption implements DrawOption
{
    ...
    public RectF drawBound(final RectF rectF) {
        ...
        final float n3 = n2 / n;
        final float n4 = (float)(SystemUtils.getScreenDefaultHeight((Context)UIComponentHelper.getInstance()) * 3);
        ...
        final float n9 = n7 + 20.0f;
        final float n10 = n8 + 20.0f;
        this.scaleCenterX = n9 / 2.0f;
        this.scaleCenterY = n10 / 2.0f;
        ...
        float n12 = n10;
        if (this.isMark) {
            (this.paint = new Paint()).setTextSize((float)ShareImageOption.MarkTextSize);
            ...
            final float n13 = measureText + 5.0f + 5.0f;
            n11 = n9;
            if (n9 < n13) {
                n11 = n13;
            }
            n12 = n10 + (bottom - top + 5.0f + 5.0f);
            this.textY = n12 - 10.0f;
            this.textX = n11 - measureText - 5.0f;
        }
        return new RectF(0.0f, 0.0f, n11, n12);
    }
