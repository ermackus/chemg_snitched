...
public final class InjectResourceSource
{
    ...
    public static int getLayoutResource(final Context context, final int n, final SelectorConfig selectorConfig) {
        if (selectorConfig != null && selectorConfig.onLayoutResourceListener != null) {
            return selectorConfig.onLayoutResourceListener.getLayoutResourceId(context, n);
        }
        return 0;
    }
}
