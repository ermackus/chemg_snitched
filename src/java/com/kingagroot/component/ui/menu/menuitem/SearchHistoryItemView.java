...
public class SearchHistoryItemView extends ToolBaseItemView
{
    boolean isCheck;
    
    public SearchHistoryItemView(final Context context) {
        super(context);
        this.init();
    }
    
    private void init() {
        this.setButtonDrawable(R$drawable.ic_src_draw_his_nor);
    ...
    public void setCheck(final boolean isCheck) {
        ...
        if (isCheck) {
            ...
            this.setButtonDrawable(R$drawable.ic_src_draw_his_sel);
        }
        else {
            this.setBackgroundResource(R$drawable.palete_menu_nor_bg);
            this.setButtonDrawable(R$drawable.ic_src_draw_his_nor);
