...
public class SkuListLink
{
    public static final String TAG = "SpuListLink";
    
    public void getSkuList(final String s) {
        ...
        final RequestParams params = build.params(NetConfig$UserOrder.sku());
        params.addBodyParameter("spuId", s);
        build.request(params, (RequestCallBack)new SkuListLink$1(this));
    }
    
    public class DataModel
    {
        private List<SpuModel> list;
        final SkuListLink this$0;
        private int total;
        
        public DataModel(final SkuListLink this$0) {
            this.this$0 = this$0;
        }
