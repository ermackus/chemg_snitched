...
public class FormatItemView extends ToolBaseItemView
{
    protected boolean isCheck;
    
    public FormatItemView(final Context context) {
        super(context);
        this.init();
    }
    
    private void init() {
        this.setButtonDrawable(R$drawable.ic_draw_96_nor);
    ...
    public void setCheck(final boolean isCheck) {
        ...
        if (isCheck) {
            ...
            this.setButtonDrawable(R$drawable.ic_draw_96_sel);
        }
        else {
            this.setBackgroundResource(R$drawable.palete_menu_nor_bg);
            this.setButtonDrawable(R$drawable.ic_draw_96_nor);
