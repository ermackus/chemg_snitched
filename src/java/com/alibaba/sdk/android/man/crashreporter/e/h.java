...
public class h
{
    ...
    public static Object a(final Class clazz, final String name, final Object[] array, final Class... parameterTypes) {
        try {
    ...
    public static Object a(Object invoke, final String name) {
        try {
            final Method declaredMethod = invoke.getClass().getSuperclass().getDeclaredMethod(name, (Class<?>[])new Class[0]);
            declaredMethod.setAccessible(true);
    ...
    public static Object a(Object invoke, final String name, final Object[] array, final Class... parameterTypes) {
        try {
            final Method declaredMethod = invoke.getClass().getSuperclass().getDeclaredMethod(name, (Class<?>[])parameterTypes);
            declaredMethod.setAccessible(true);
    ...
    public static Object a(final String className, final String s, final Object[] array, final Class... array2) {
        try {
            final Class<?> forName = Class.forName(className);
            if (forName != null) {
                return a(forName, s, array, array2);
            }
            return null;
        }
        catch (final ClassNotFoundException ex) {
    ...
    public static Object b(Object invoke, final String name) {
        try {
    ...
    public static Object b(Object invoke, final String name, final Object[] array, final Class... parameterTypes) {
        try {
