...
public class PaletteBottomView extends LinearLayout implements BaseToolMenu, View$OnLongClickListener
{
    ...
    private GRadioButton rbtArrow;
    private GRadioButton rbtBondDouble;
    private GRadioButton rbtBracket;
    private GRadioButton rbtCharge;
    private GRadioButton rbtFlow;
    private GRadioButton rbtOrbital;
    private RadioGroup rgElementTool;
    private HorizontalScrollView scrollView;
    
    public PaletteBottomView(final Context context, final AttributeSet set) {
        super(context, set);
        this.context = context;
        this.contentView = View.inflate(context, R$layout.component_view_compound_base, (ViewGroup)this);
        this.initView();
        this.intData();
    }
    ...
    private void initView() {
        ...
        this.rbtArrow = (GRadioButton)this.findViewById(R$id.rbt_arrow);
        this.rbtCharge = (GRadioButton)this.findViewById(R$id.rbt_charge);
        this.rbtFlow = (GRadioButton)this.findViewById(R$id.rbt_flow);
        this.rbtBracket = (GRadioButton)this.findViewById(R$id.rbt_bracket);
        this.rbtOrbital = (GRadioButton)this.findViewById(R$id.rbt_orbital);
        ...
        this.rgElementTool.setOnCheckedChangeListener((RadioGroup$OnCheckedChangeListener)new PaletteBottomView$1(this));
        this.rbtBondDouble.setOnLongClickListener((View$OnLongClickListener)this);
        this.rbtArrow.setOnLongClickListener((View$OnLongClickListener)this);
        this.rbtCharge.setOnLongClickListener((View$OnLongClickListener)this);
        this.rbtFlow.setOnLongClickListener((View$OnLongClickListener)this);
        this.rbtBracket.setOnLongClickListener((View$OnLongClickListener)this);
        this.rbtOrbital.setOnLongClickListener((View$OnLongClickListener)this);
        checkBox.setOnCheckedChangeListener((CompoundButton$OnCheckedChangeListener)new PaletteBottomView$2(this));
    }
    
    private void intData() {
        this.rbtBondDouble.setTag((Object)ToolEnum.GBOND_DOUBLE_TOOL.id);
        this.rbtArrow.setTag((Object)ToolEnum.G_SOLID_ARROW_SMALL_TOOL.id);
        this.rbtCharge.setTag((Object)ToolEnum.GCHARGE_POSITIVE_TOOL.id);
        this.rbtFlow.setTag((Object)ToolEnum.GFLOW_RECTANGLE_TOOL.id);
        this.rbtBracket.setTag((Object)ToolEnum.GBRACKET_RECT_TOOL.id);
        this.rbtOrbital.setTag((Object)ToolEnum.ORBITAL_CIRCLE_WHITE.id);
    }
    ...
    public boolean onLongClick(final View view) {
        ...
        if (gRadioButton.hasMore()) {
            ...
            else if (gRadioButton == this.rbtArrow) {
                bottomToolsPop.setToolModels((List<ToolModel>)PaletteToolsData.getArrowTools());
            }
            else if (gRadioButton == this.rbtCharge) {
                bottomToolsPop.setToolModels((List<ToolModel>)PaletteToolsData.getChargeTools());
            }
            else if (gRadioButton == this.rbtFlow) {
                bottomToolsPop.setToolModels((List<ToolModel>)PaletteToolsData.getFlowTools());
            }
            else if (gRadioButton == this.rbtBracket) {
                bottomToolsPop.setToolModels((List<ToolModel>)PaletteToolsData.getBracketTools());
            }
            else if (gRadioButton == this.rbtOrbital) {
                bottomToolsPop.setToolModels((List<ToolModel>)PaletteToolsData.getOrbitalTools());
            }
            bottomToolsPop.setOldCheck(ToolEnum.getValueById((int)gRadioButton.getTag()));
            bottomToolsPop.show((View)gRadioButton);
            this.scrollView.setOnTouchListener((View$OnTouchListener)new PaletteBottomView$3(this));
            bottomToolsPop.setOnDismissListener((PopupWindow$OnDismissListener)new PaletteBottomView$4(this, gRadioButton));
            bottomToolsPop.setOnToolsPopListener((PaletteBasePop$OnToolsPopListener)new PaletteBasePop$OnToolsPopListener(this, gRadioButton) {
                final PaletteBottomView this$0;
