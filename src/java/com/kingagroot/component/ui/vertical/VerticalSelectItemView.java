...
import com.kingagroot.component.ui.menu.menuitem.SecondaryMenuItem;
import java.util.List;
import android.view.View$OnLongClickListener;
import com.kingagroot.component.ui.menu.menuitem.ToolBaseItemView;

public class VerticalSelectItemView extends ToolBaseItemView implements View$OnLongClickListener
{
    private boolean isCheck;
    private final List<SecondaryMenuItem> menuItems;
    private ToolEnum toolEnum;
    
    public VerticalSelectItemView(final Context context) {
        super(context);
    ...
    private void initMenuItems() {
        for (final ToolModel toolModel : this.getSelectorTools()) {
            ...
            secondaryMenuItem.setOnMenuClickListener((OnMenuClickListener)new VerticalSelectItemView$1(this));
    ...
    public boolean onLongClick(final View view) {
        ...
        if (this.moreMenuPop != null) {
            ...
            moreMenuPop.verticalShow((View)this);
            moreMenuPop.setOnDismissListener((PopupWindow$OnDismissListener)new VerticalSelectItemView$2(this));
        }
        return true;
    }
