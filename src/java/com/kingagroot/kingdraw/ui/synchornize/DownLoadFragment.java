...
import com.kingagroot.kingdraw.model.SynFolderModel;
...
public class DownLoadFragment extends SynView implements SynchornizeAdapter$OnSynChronizeAdapterListner
{
    ...
    public DownLoadFragment() {
        ...
        this.receiver = (BroadcastReceiver)new DownLoadFragment$1(this);
    }
    
    private boolean downLoadFinish(final SynFileModel synFileModel) {
    ...
    private void initData() {
        ...
        final List downLodFileModels = ((SynFileDBI)synFileDBI).getDownLodFileModels();
        this.folderFileModels.clear();
        if (downLodFileModels != null) {
            this.folderFileModels.addAll((Collection)downLodFileModels);
        }
        (this.adapter = new SynchornizeAdapter(this.getContext(), (List)this.folderFileModels, true)).setOnSynChronizeAdapterListner((SynchornizeAdapter$OnSynChronizeAdapterListner)this);
    ...
    public View onCreateView(final LayoutInflater layoutInflater, final ViewGroup viewGroup, final Bundle bundle) {
        final View inflate = layoutInflater.inflate(2131493061, viewGroup, false);
    ...
    public void onRestart(final SynFileModel synFileModel, final int n) {
        final SynFolderModel synFolderModel = (SynFolderModel)new Gson().fromJson(synFileModel.getFolderFileModelStr(), (Class)SynFolderModel.class);
        ...
        final WordBreakTextView wordBreakTextView = (WordBreakTextView)inflate.findViewById(2131297623);
        String fileName;
        if (TextUtils.isEmpty((CharSequence)(fileName = synFolderModel.getFileName()))) {
            fileName = "";
        }
        wordBreakTextView.setText(this.getString(2131821322), new Object[] { fileName });
        alertDialog$Builder.setView(inflate);
        alertDialog$Builder.setTitle((CharSequence)this.getString(2131821524)).setPositiveButton((CharSequence)this.getString(2131821321), (DialogInterface$OnClickListener)new _$$Lambda$DownLoadFragment$cLALXhGZ3lGT8Iemb4xbqnHFs7g(this, synFileModel)).setNegativeButton((CharSequence)this.getString(2131820663), (DialogInterface$OnClickListener)new _$$Lambda$DownLoadFragment$QIwnfTVjdX5_5959TIC7uvArHyo(this, synFileModel, n)).setNeutralButton((CharSequence)this.getString(2131820967), (DialogInterface$OnClickListener)null);
    ...
    public void updateView(final int n, final SynFileModel synFileModel) {
        ...
        else if (this.downLoadFinish(synFileModel)) {
