...
public class PhotoViewAttacher implements View$OnTouchListener, View$OnLayoutChangeListener
{
    ...
    public PhotoViewAttacher(final ImageView mImageView) {
        ...
        this.mMinScale = PhotoViewAttacher.DEFAULT_MIN_SCALE;
        ...
        this.onGestureListener = new OnGestureListener() {
            ...
            public void onDrag(final float n, final float n2) {
                if (this.this$0.mScaleDragDetector.isScaling()) {
                    return;
                }
                if (this.this$0.mOnViewDragListener != null) {
                    this.this$0.mOnViewDragListener.onDrag(n, n2);
                }
                this.this$0.mSuppMatrix.postTranslate(n, n2);
                this.this$0.checkAndDisplayMatrix();
                final ViewParent parent = this.this$0.mImageView.getParent();
                if (this.this$0.mAllowParentInterceptOnEdge && !this.this$0.mScaleDragDetector.isScaling() && !this.this$0.mBlockParentIntercept) {
                    if ((this.this$0.mHorizontalScrollEdge == 2 || (this.this$0.mHorizontalScrollEdge == 0 && n >= 1.0f) || (this.this$0.mHorizontalScrollEdge == 1 && n <= -1.0f) || (this.this$0.mVerticalScrollEdge == 0 && n2 >= 1.0f) || (this.this$0.mVerticalScrollEdge == 1 && n2 <= -1.0f)) && parent != null) {
            ...
            public void onFling(final float n, final float n2, final float n3, final float n4) {
                final PhotoViewAttacher this$0 = this.this$0;
                this$0.mCurrentFlingRunnable = this$0.new FlingRunnable(this$0.mImageView.getContext());
                final FlingRunnable access$900 = this.this$0.mCurrentFlingRunnable;
                final PhotoViewAttacher this$2 = this.this$0;
                final int access$901 = this$2.getImageViewWidth(this$2.mImageView);
                final PhotoViewAttacher this$3 = this.this$0;
                access$900.fling(access$901, this$3.getImageViewHeight(this$3.mImageView), (int)n3, (int)n4);
                this.this$0.mImageView.post((Runnable)this.this$0.mCurrentFlingRunnable);
            }
            
            @Override
            public void onScale(final float n, final float n2, final float n3) {
                if (this.this$0.getScale() < this.this$0.mMaxScale || n < 1.0f) {
                    if (this.this$0.mScaleChangeListener != null) {
                        this.this$0.mScaleChangeListener.onScaleChange(n, n2, n3);
                    }
                    this.this$0.mSuppMatrix.postScale(n, n, n2, n3);
                    this.this$0.checkAndDisplayMatrix();
                }
            }
        };
        ...
        (this.mGestureDetector = new GestureDetector(mImageView.getContext(), (GestureDetector$OnGestureListener)new GestureDetector$SimpleOnGestureListener(this) {
            ...
            public boolean onFling(final MotionEvent motionEvent, final MotionEvent motionEvent2, final float n, final float n2) {
                if (this.this$0.mSingleFlingListener != null) {
                    if (this.this$0.getScale() > PhotoViewAttacher.DEFAULT_MIN_SCALE) {
                        return false;
                    }
                    if (motionEvent.getPointerCount() <= PhotoViewAttacher.SINGLE_TOUCH) {
                        if (motionEvent2.getPointerCount() <= PhotoViewAttacher.SINGLE_TOUCH) {
