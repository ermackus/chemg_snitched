...
{
    public final ArrayList<LocalMediaFolder> albumDataSource;
    ...
    public final ArrayList<LocalMedia> dataSource;
    ...
    public final ArrayList<LocalMedia> selectedPreviewResult;
    public final ArrayList<LocalMedia> selectedResult;
    ...
    public SelectorConfig() {
        this.selectedResult = (ArrayList<LocalMedia>)new ArrayList();
        this.selectedPreviewResult = (ArrayList<LocalMedia>)new ArrayList();
        this.albumDataSource = (ArrayList<LocalMediaFolder>)new ArrayList();
        this.dataSource = (ArrayList<LocalMedia>)new ArrayList();
    ...
    private void initDefaultValue() {
        ...
        this.queryOnlyList = (List<String>)new ArrayList();
        ...
        this.isSyncCover = (SdkVersionUtils.isQ() ^ true);
        ...
        this.skipCropList = (List<String>)new ArrayList();
        this.sortOrder = "";
    ...
    public void addAlbumDataSource(final List<LocalMediaFolder> list) {
        if (list != null) {
            this.albumDataSource.clear();
            this.albumDataSource.addAll((Collection)list);
        }
    }
    
    public void addAllSelectResult(final ArrayList<LocalMedia> list) {
        this.selectedResult.addAll((Collection)list);
    }
    
    public void addDataSource(final ArrayList<LocalMedia> list) {
        if (list != null) {
            this.dataSource.clear();
            this.dataSource.addAll((Collection)list);
        }
    }
    
    public void addSelectResult(final LocalMedia localMedia) {
        this.selectedResult.add((Object)localMedia);
    }
    
    public void addSelectedPreviewResult(final ArrayList<LocalMedia> list) {
        if (list != null) {
            this.selectedPreviewResult.clear();
            this.selectedPreviewResult.addAll((Collection)list);
        }
    }
    ...
    public String getResultFirstMimeType() {
        ...
        if (this.selectedResult.size() > 0) {
            mimeType = ((LocalMedia)this.selectedResult.get(0)).getMimeType();
        }
        else {
            mimeType = "";
        }
