...
public class GestureItemAdapter extends BaseAdapter
{
    ...
    public GestureItemAdapter(final Context context, final List<GestureGroupModel> gestureGroupModels) {
    ...
    public View getView(final int n, View inflate, final ViewGroup viewGroup) {
        ...
        tag.ivItem.setImageResource(GBitmapUtils.getResId(this.context, item.getBondRes()));
