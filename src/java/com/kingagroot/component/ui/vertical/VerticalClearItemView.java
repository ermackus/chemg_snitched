...
public class VerticalClearItemView extends ToolBaseItemView implements View$OnLongClickListener
{
    private boolean isCheck;
    private final List<SecondaryMenuItem> menuItems;
    private ToolEnum toolEnum;
    
    public VerticalClearItemView(final Context context) {
        super(context);
    ...
    private void initMenuItems() {
        for (final ToolModel toolModel : this.getClearTools()) {
            ...
            secondaryMenuItem.setOnMenuClickListener((OnMenuClickListener)new VerticalClearItemView$2(this));
    ...
    public boolean onLongClick(final View view) {
        ...
        if (this.moreMenuPop != null) {
            ...
            moreMenuPop.setOnDismissListener((PopupWindow$OnDismissListener)new VerticalClearItemView$1(this));
        }
        return true;
    }
