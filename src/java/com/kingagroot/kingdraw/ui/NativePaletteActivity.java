...
public class NativePaletteActivity extends NewPaletteRotateActivity
{
    ...
    private void autoSave() {
        ...
        this.startSave();
        new Thread((Runnable)new NativePaletteActivity$2(this)).start();
    }
    ...
    private void initFinish() {
        this.runOnUiThread((Runnable)new _$$Lambda$NativePaletteActivity$0UeV24PV1iQH4y_UJMgQdvpHuC0(this));
    }
    ...
    private void kingVersionWarringDialog(final NewPaletteRotateActivity$WarringCallback newPaletteRotateActivity$WarringCallback) {
        this.runOnUiThread((Runnable)new _$$Lambda$NativePaletteActivity$9_5UM3kvYpomO_Qpr2_y_EKJNZA(this, newPaletteRotateActivity$WarringCallback));
    }
    
    private void openFileByModel(final String s) {
        new Thread((Runnable)new _$$Lambda$NativePaletteActivity$kVoDXYdYOkJ71fx7aVQvqCqPZiw(this, s)).start();
    }
    
    private void readFail() {
        this.runOnUiThread((Runnable)new _$$Lambda$NativePaletteActivity$TxiW55koIwrzz8EjOV7OjyRseTU(this));
    }
    ...
    private void saveFile() {
        ...
        withView.writeToFile(parent, s, this.protocolTypeEnum);
    ...
    protected void initView() {
        super.initView();
        this.verticalTopTool.enableSaveAs(false);
    ...
    public void onKingDrawViewAvailable() {
        ...
        if (extras != null) {
            ...
            if (nativeHandlerParam != null) {
                this.setFileName(DrawFileUtil.getFileNameNoExtension(nativeHandlerParam.fileName));
                ...
                if (this.nativeHandlerParam.autoSave) {
                    ...
                    if (this.nativeHandlerParam.saveInterval > 0L) {
                        (this.countDownTimer = (CountDownTimer)new NativePaletteActivity$1(this, this.nativeHandlerParam.saveInterval, this.nativeHandlerParam.saveInterval)).start();
                        n2 = n3;
                    }
                }
            }
