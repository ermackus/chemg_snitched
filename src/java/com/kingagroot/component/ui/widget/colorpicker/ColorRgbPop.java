...
public class ColorRgbPop extends Dialog
{
    private final View contentView;
    private EditText etColorB;
    private EditText etColorG;
    private EditText etColorR;
    private final ColorPicker.OnColorChangedListener onColorChangedListener;
    ...
    public ColorRgbPop(final Context context) {
        super(context);
        this.textWatcher = (TextWatcher)new TextWatcher() {
            final ColorRgbPop this$0;
        ...
        this.onColorChangedListener = (ColorPicker.OnColorChangedListener)new ColorRgbPop$2(this);
        this.requestWindowFeature(1);
        final LayoutInflater layoutInflater = (LayoutInflater)context.getSystemService("layout_inflater");
        View inflate = null;
        if (layoutInflater != null) {
            inflate = layoutInflater.inflate(R.layout.component_pop_color_rgb, (ViewGroup)null);
        }
